...
# "hobo_1_filename"     Change to File name of Hobo Plug Load Logger exported file
# "hobo_2_filename"     Change to File name of Hobo Motion/Light Logger exported file
...
table_name = "HoboExampleDATA"  # Name of database table to write to
