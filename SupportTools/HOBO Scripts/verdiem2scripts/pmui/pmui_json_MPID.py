...
# "input_file_name"     Change to PMUI systemEvents.db or systemEvents.json data file
...
table_name = "pmui_json_ExampleDATA"  # Name of database table to write to
...
#period_in_day = 96  # number of columns in DB corresponds to minute resolution (96 is default for 15 minute blocks)
unknown_for_fringes = 1
# use_unknown_for_everyday = 1

auto_timezone_adjust = True
auto_timezone = pytz.timezone(
    'America/Los_Angeles')  # Set po'[;/.,/.timezone for subject, assume pacific for California for CalPlug studies
...
CREATE TABLE `pmui_json_ExampleDATA` (
